...
func (mr *MockVersionServiceMockRecorder) CreateVersion(c, file, postID interface{}) *gomock.Call {
...
func (mr *MockVersionServiceMockRecorder) GetRender(versionID, postID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVersionServiceMockRecorder) GetRepository(versionID, postID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
